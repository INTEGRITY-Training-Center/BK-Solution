                                ...
                                <div class="account-content pt-1 pb-1">
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                                ...
                                                <asp:TextBox ID="txtName" runat="server" autocomplete="off" CssClass="form-control" placeholder="အမည်" Required></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                                ...
                                                <asp:TextBox ID="txtMobileNo" TextMode="Phone" autocomplete="off" runat="server" CssClass="form-control" placeholder="ဖုန်းနံပတ်" Required></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                                ...
                                                <asp:TextBox ID="txtAddress" runat="server" autocomplete="off" TextMode="MultiLine" CssClass="form-control" placeholder="လိပ်စာ" Required></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                               ...
                                               <%-- <label for="txtpw" class="col-md-7 col-xs-7 p-0 disabled" >Password</label> --%>
                                                ...
                                                <%--<asp:TextBox ID="txtpw" runat="server" autocomplete="off" CssClass="form-control disabled" TextMode="Password" placeholder="Enter Your Password"   ></asp:TextBox>
                                                --%>
                                            </div>
                                        </div>
                                        <div class="form-group m-b-20">
                                         ...
                                         <%--   <div class="row">
                                            ...
                                            <div class="col-md-10 offset-2 p-0 text-right" >
                                                ...
                                                <%--<asp:Button ID="btnSubmit" runat="server" Text="Submit"  CssClass="btn btn-primary mt-1 " ValidationGroup="def"  OnClick="btnSubmit_Click" />--%>
                                                    ...
                                                    <button type="button" class="btn btn-primary mt-1" runat="server" id="btnSign" onserverclick="btnSubmit_Click"><i class="fas fa-registered"></i>&nbsp; အတည်ပြုမည်</button>
