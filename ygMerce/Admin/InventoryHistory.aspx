<%@ Page Title="" Language="C#" MasterPageFile="~/ygn.Master" AutoEventWireup="true" CodeBehind="InventoryHistory.aspx.cs" Inherits="ygMerce.InventoryHistory" %>
    ...
    <div class="container">
        ...
        <div class="content row">
            ...
            <div class="col-sm-8 overflow">
                ...
                <asp:GridView Style="width: 100%;" ID="InventoryHisGv" runat="server"></asp:GridView>
            </div>
            <div class="col-sm-2"></div>
        </div>
            ...
            <div class="col-sm-8">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtProductQtty" placeholder="Quantity" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox><br /><br />
                    </div>
